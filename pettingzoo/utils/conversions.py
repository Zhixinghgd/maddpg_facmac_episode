...
class aec_to_parallel_wrapper(ParallelEnv):
    ...
    def step(self, actions):
        ...
        # 计算全局奖励
        scenario = self.aec_env.unwrapped.scenario  # 获取 scenario 对象
        world = self.aec_env.unwrapped.world  # 获取 world 对象
        total_reward = scenario.calculate_total_reward(world)  # 计算总奖励
        # total_reward =
        ...
        self.agents = self.aec_env.agents
        return observations, rewards, total_reward, dones, infos
